...
th_chose(-4).TH_name = LoadResString_(1945, "") '"美奈劳嘶定理"
th_chose(-4).chose = 1
...
th_chose(-3).TH_name = LoadResString_(1950, "") '和（分）比定理
th_chose(-3).chose = 1
th_chose(-3).text = LoadResString_(1950, "")
th_chose(-3).chapter = 0
th_chose(-2).TH_name = LoadResString_(2070, "") '韦达定理
th_chose(-2).chose = 1
th_chose(-2).text = LoadResString_(2075, "")
th_chose(-2).chapter = 0
th_chose(-1).TH_name = LoadResString_(2080, "") '一元二次方程的求根公式
th_chose(-1).chose = 1
th_chose(-1).text = LoadResString_(2085, "")
th_chose(-1).chapter = 0
th_chose(1).TH_name = LoadResString_(2090, "") '等量替换
th_chose(1).chose = 1
th_chose(1).text = LoadResString_(2095, "")
th_chose(1).chapter = 0
th_chose(2).TH_name = LoadResString_(2100, "") '勾股定理逆定理
th_chose(2).chose = 1
th_chose(2).text = LoadResString_(2330, "")
th_chose(2).chapter = 0
th_chose(3).TH_name = LoadResString_(2335, "") '梯形的面积公式
th_chose(3).chose = 1
th_chose(3).text = LoadResString_(2340, "") '圆的面积公式
th_chose(3).chapter = 0
th_chose(4).TH_name = LoadResString_(2345, "")
th_chose(4).chose = 1
th_chose(4).text = LoadResString_(2350, "")
th_chose(4).chapter = 0
th_chose(5).TH_name = LoadResString_(2355, "") '圆的周长公式
th_chose(5).chose = 1
th_chose(5).text = LoadResString_(2360, "")
th_chose(5).chapter = 0
th_chose(6).TH_name = LoadResString_(2365, "") '对顶角相等
th_chose(6).chose = 1
th_chose(6).text = LoadResString_(2365, "")
th_chose(6).chapter = 201
th_chose(7).TH_name = LoadResString_(2370, "") '平行线公理的推理
th_chose(7).chose = 1
th_chose(7).text = LoadResString_(2375, "")
th_chose(7).chapter = 204
th_chose(8).TH_name = LoadResString_(2380, "") '平行线判断定理一（同位角相等）
th_chose(8).chose = 1
th_chose(8).text = LoadResString_(2385, "")
th_chose(8).chapter = 206
th_chose(9).TH_name = LoadResString_(2390, "") '平行线判断定理二（内错角相等）
th_chose(9).chose = 1
th_chose(9).text = LoadResString_(2395, "")
th_chose(9).chapter = 206
th_chose(10).TH_name = LoadResString_(2400, "") '平行线判断定理三（同旁内角互补）
th_chose(10).chose = 1
th_chose(10).text = LoadResString_(2405, "")
th_chose(10).chapter = 206
th_chose(11).TH_name = LoadResString_(2410, "") '平行线定理一（同位角相等
th_chose(11).chose = 1
th_chose(11).text = LoadResString_(2415, "")
th_chose(11).chapter = 207
th_chose(12).TH_name = LoadResString_(2420, "") '平行线定理二（内错角相等）
th_chose(12).chose = 1
th_chose(12).text = LoadResString_(2425, "")
th_chose(12).chapter = 207
th_chose(13).TH_name = LoadResString_(2430, "") '平行线定理三（同旁内角互补）
th_chose(13).chose = 1
th_chose(13).text = LoadResString_(2435, "")
th_chose(13).chapter = 207
th_chose(14).TH_name = LoadResString_(2440, "") '平行线定理四（一个角的两边分布平行另一个角的两边，此两角相等）
th_chose(14).chose = 1
th_chose(14).text = LoadResString_(2445, "")
th_chose(14).chapter = 207
th_chose(15).TH_name = LoadResString_(2450, "") '垂线定理一（两直线都垂直同一直线此两直线平行）
th_chose(15).chose = 1
th_chose(15).text = LoadResString_(2455, "")
th_chose(15).chapter = 208
th_chose(16).TH_name = LoadResString_(2460, "") '垂线定理二（一条直线和两平行线中一条垂直，那么也与另一条垂直）
th_chose(16).chose = 1
th_chose(16).text = LoadResString_(2465, "")
th_chose(16).chapter = 208
th_chose(17).TH_name = LoadResString_(2470, "") '垂线定理二（一角的两边分别与另一角的两边垂直，那么两角相等或互补）
th_chose(17).chose = 1
th_chose(17).text = LoadResString_(2475, "")
th_chose(17).chapter = 208
th_chose(18).TH_name = LoadResString_(2480, "") '三角形边长大小关系定理一（两边之和大于第三边）
th_chose(18).chose = 1
th_chose(18).text = LoadResString_(2485, "")
th_chose(18).chapter = 302
th_chose(19).TH_name = LoadResString_(2490, "") '三角形边长大小关系定理二（两边之差小于第三边）
th_chose(19).chose = 1
th_chose(19).text = LoadResString_(2495, "")
th_chose(19).chapter = 302
th_chose(20).TH_name = LoadResString_(2500, "") '三角形内角和定理（内角和=180）
th_chose(20).chose = 1
th_chose(20).text = LoadResString_(2505, "")
th_chose(20).chapter = 303
th_chose(21).TH_name = LoadResString_(2510, "") '角形内角和定理推论一（直角三角形两锐角互补）
th_chose(21).chose = 1
th_chose(21).text = LoadResString_(2515, "")
th_chose(21).chapter = 303
th_chose(22).TH_name = LoadResString_(2520, "") '角形内角和定理推论二（三角形一个外角等于不相邻的两内角和）
th_chose(22).chose = 1
th_chose(22).text = LoadResString_(2525, "")
th_chose(22).chapter = 303
th_chose(23).TH_name = LoadResString_(2530, "") '角形内角和定理推论三（三角形一个外角大于任何一个不相邻的两内角）
th_chose(23).chose = 1
th_chose(23).text = LoadResString_(2535, "")
th_chose(23).chapter = 303
th_chose(24).TH_name = LoadResString_(2540, "") '全等三角形性质定理一（对应边相等）
th_chose(24).chose = 1
th_chose(24).text = LoadResString_(2545, "")
th_chose(24).chapter = 304
th_chose(25).TH_name = LoadResString_(2550, "") '全等三角形性质定理二（对应角相等）
th_chose(25).chose = 1
th_chose(25).text = LoadResString_(2555, "")
th_chose(25).chapter = 303
th_chose(26).TH_name = LoadResString_(2560, "") '全等三角形性质定理三（对应的高，中线，角平分线相等）
th_chose(26).chose = 1
th_chose(26).text = LoadResString_(2565, "")
th_chose(26).chapter = 303
th_chose(27).TH_name = LoadResString_(2570, "") '全等三角形性质定理四（面积相等）
th_chose(27).chose = 1
th_chose(27).text = LoadResString_(2575, "")
th_chose(27).chapter = 303
th_chose(28).TH_name = LoadResString_(2580, "") '三角形全等的判断定理一（SAS）
th_chose(28).chose = 1
th_chose(28).text = LoadResString_(2585, "")
th_chose(28).chapter = 304
th_chose(29).TH_name = LoadResString_(2590, "") '三角形全等的判断定理二（ASA）
th_chose(29).chose = 1
th_chose(29).text = LoadResString_(2595, "")
th_chose(29).chapter = 304
th_chose(30).TH_name = LoadResString_(2600, "") '三角形全等的判断定理二的推论（AAS）
th_chose(30).chose = 1
th_chose(30).text = LoadResString_(2605, "")
th_chose(30).chapter = 304
th_chose(31).TH_name = LoadResString_(2610, "") '三角形全等的判断定理三（SSS）
th_chose(31).chose = 1
th_chose(31).text = LoadResString_(2615, "")
th_chose(31).chapter = 304
th_chose(32).TH_name = LoadResString_(2620, "") '直角三角形全等判断定理（RS）
th_chose(32).chose = 1
th_chose(32).text = LoadResString_(2625, "")
th_chose(32).chapter = 304
th_chose(33).TH_name = LoadResString_(2630, "") '角平分线性质定理（叫平分线上的点到角的两边距离相等）
th_chose(33).chose = 1
th_chose(33).text = LoadResString_(2635, "")
th_chose(33).chapter = 309
th_chose(34).TH_name = LoadResString_(2640, "") '角平分线性质定理二（到角的两边距离相等的点在角平分线上）
th_chose(34).chose = 1
th_chose(34).text = LoadResString_(2645, "")
th_chose(34).chapter = 309
th_chose(35).TH_name = LoadResString_(2650, "") '角平分线判断定理？？？？
th_chose(35).chose = 1
th_chose(35).text = LoadResString_(2655, "")
th_chose(35).chapter = 309
th_chose(36).TH_name = LoadResString_(2660, "") '等腰三角形的性质定理（底角相等）
th_chose(36).chose = 1
th_chose(36).text = LoadResString_(2665, "")
th_chose(36).chapter = 312
th_chose(37).TH_name = LoadResString_(2670, "") '中心对称定理二（）？？？？
th_chose(37).chose = 1
th_chose(37).text = LoadResString_(2675, "")
th_chose(37).chapter = 312
th_chose(38).TH_name = LoadResString_(2680, "") '等要三角形性质推论二（等边三角形内角等于60）？？？
th_chose(38).chose = 1
th_chose(38).text = LoadResString_(2685, "")
th_chose(38).chapter = 312
th_chose(39).TH_name = LoadResString_(2690, "") '等要三角形性质推论三（顶角平分线，底边上的高和中线合一）
th_chose(39).chose = 1
th_chose(39).text = LoadResString_(2695, "")
th_chose(39).chapter = 312
th_chose(40).TH_name = LoadResString_(2700, "") '等要三角形判断定理（有两个内角相等）
th_chose(40).chose = 1
th_chose(40).text = LoadResString_(2705, "")
th_chose(40).chapter = 313
th_chose(41).TH_name = LoadResString_(2710, "") '等要三角形判断定理推论一（三个内角都相等的三角形是等边三角形）
th_chose(41).chose = 1
th_chose(41).text = LoadResString_(2715, "")
th_chose(41).chapter = 313
th_chose(42).TH_name = LoadResString_(2720, "") '等要三角形判断定理推论二（一个角等于60度的三角形是等边三角形）
th_chose(42).chose = 1
th_chose(42).text = LoadResString_(2725, "")
th_chose(42).chapter = 313
th_chose(43).TH_name = LoadResString_(2730, "") '等要三角形判断定理推论三（直叫三角形39度的角所对的边是斜边的一半）
th_chose(43).chose = 1
...
inform.Picture1.Cls
Call set_information_list(two_angle_180_)
End Sub
...
Do While EOF(1) <> True
 last_record = last_record + 1
  Get #1, last_record, inpcond0
       n% = InStr(1, inpcond0.inpcond(regist_data.language - 1), "%")
        If n% > 0 Then
          inpcond(inpcond0.no).inpcond = Mid$(inpcond0.inpcond(regist_data.language - 1), 1, n% - 1) + Chr(13)
        Else
         n% = InStr(1, inpcond0.inpcond(regist_data.language - 1), Chr(13))
          If n% > 0 Then
            inpcond(inpcond0.no).inpcond = Mid$(inpcond0.inpcond(regist_data.language - 1), 1, n%)
          Else
            inpcond(inpcond0.no).inpcond = Trim(inpcond0.inpcond(regist_data.language - 1)) + Chr(13)
          End If
        End If
...
Public Sub set_wenti_from_size()
Wenti_form.top = MDIForm1.top
Wenti_form.left = MDIForm1.left + MDIForm1.width / 2 - 160
Wenti_form.width = MDIForm1.width / 2 - 160
Wenti_form.Height = MDIForm1.Height
End Sub

Public Sub set_draw_form_size()
Draw_form.top = MDIForm1.top
Draw_form.left = MDIForm1.left
Draw_form.width = MDIForm1.width / 2 - 160
Draw_form.Height = MDIForm1.Height
End Sub
