...
If inputcond_no = -71 Then
   ...
   Call add_point_to_m_circle(tangent_point_no(0), tangent_circle_no%, record0, True)
'*******************************************************************************************************
   ...
   Call add_point_to_m_circle(tangent_point_no(1), tangent_circle_no%, record0, True)
'****************************************************************************************************************
...
If m_poi(p0%).data(0).parent.inter_type = interset_point_line_line Then
    Call set_wenti_cond_22_23(p3%, p1%, p2%, m_poi(p0%).data(0).parent.element(1).no, m_poi(p0%).data(0).parent.element(2).no, p0%, 0)
ElseIf m_poi(p0%).data(0).parent.inter_type = new_point_on_line_circle12 Or _
    ...
    Call set_wenti_cond10_16(p3%, p1%, p2%, m_poi(p0%).data(0).parent.element(2).no, p0%, 0, paral_or_verti, _
         m_poi(p0%).data(0).parent.inter_type)
Else
'End If
If w_n% = 0 Then
tp1(0) = p0%
